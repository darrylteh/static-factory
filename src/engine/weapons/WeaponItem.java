...
public abstract class WeaponItem extends Item implements Weapon {
	...
	/**
	 * This method overwrites the existing damage value with the given input.
	 * For example, this could be used to reset the damage of the weapon back to the initial damage.
	 * @param damage the new damage value to overwrite the existing one.
	 */
	...
	/**
	 * This method increases the existing damage value with the given input.
	 * It will not overwrite the existing damage value.
	 * @param damage the new damage to be added to the existing damage value
	 */
